...
namespace Wiki.DataAccess.Migrations
{
    ...
    [Migration("20241115171859_ManyToManyMappingAdded")]
    partial class ManyToManyMappingAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("Wiki.Model.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsAuthor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wiki.Model.Models.Book", null)
                        .WithMany()
